...
-- declared in the KeywordSearch.hs file.
module Settings
    ( hamletFile
    , cassiusFile
    , juliusFile
...
approot = "http://search.boringtosser.co.uk"
#else
...
--
-- If you change the resource pattern for StaticR in KeywordSearch.hs, you will
-- have to make a corresponding change here.
--
-- To see how this value is used, see urlRenderOverride in KeywordSearch.hs
staticroot :: Text
